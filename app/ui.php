  ...
  <div class="max-w-7xl mx-auto px-6 py-5 flex items-center justify-between">
    ...
    <div class="flex items-center gap-3 flex-wrap justify-end">
      <?php if ($user): ?>
        ...
        <a href="/bookwave/public/profile.php" class="px-3 py-2 rounded border text-sm">Perfil</a>
        <a href="/bookwave/public/my_rentals.php" class="px-3 py-2 rounded border text-sm">Meus Alugueres</a>
        <?php if ((int)$user['is_admin'] === 1): ?>
          <a href="/bookwave/public/admin.php" class="px-3 py-2 rounded border text-sm">Admin</a>
          <a href="/bookwave/public/admin_users.php" class="px-3 py-2 rounded border text-sm">Clientes</a>
        <?php endif; ?>
        <a href="/bookwave/public/logout.php" class="px-3 py-2 rounded bg-slate-900 text-white text-sm">Sair</a>
      <?php else: ?>
        <a href="/bookwave/public/login.php" class="px-3 py-2 rounded bg-slate-900 text-white text-sm">Entrar</a>
        <a href="/bookwave/public/register.php" class="px-3 py-2 rounded border text-sm">Registar</a>
      <?php endif; ?>
    </div>
  </div>
</header>
...
<footer class="bg-slate-900 text-gray-300 mt-16">
  <div class="max-w-7xl mx-auto px-6 py-12 grid md:grid-cols-3 gap-10">
    ...
    <div>
      ...
      <p class="text-sm text-gray-400">📍 Rua dos Livros, 123<br>1000-001 Lisboa<br>Portugal</p>
    </div>
  </div>
